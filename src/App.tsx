...
export type Page='Dashboard'|'Data Explorer'|'Standards'|'About';
const routes:Record<Page,string>={'Dashboard':'dashboard','Data Explorer':'data-explorer','Standards':'standards','About':'about'};
...
function Shell(){
  ...
  const content=page==='Dashboard'?<DashboardPage/>:page==='Data Explorer'?<DataExplorerPage/>:page==='Standards'?<StandardsPage/>:<AboutPage/>;
